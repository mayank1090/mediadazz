      ...
      >
        ...
        <div className="relative w-full flex gap-2.5">
          ...
          {showSuggestions && filtered.length > 0 && (
            <div className="fixed sm:absolute left-0 top-[25%] sm:top-[110%] w-screen  sm:w-full z-30 sm:rounded-2xl bg-white shadow-2xl border border-[#EEEEEE] py-2 max-h-[420px] overflow-y-auto">
