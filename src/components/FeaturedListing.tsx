import { SameSellerListing } from "@/store/productApi";
import Listingcarousel from "./listingcarousel";
import { Listing } from "./listingcarousel";


export default function FeatureListing ({listings}: {listings: Listing[]}){
    return(<>
    ...
    <Listingcarousel listings={listings} city="dubai"/>
    </div>
    </>)
}