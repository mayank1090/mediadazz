        ...
        <div className="py-[3.375rem] px-6 lg:p-24  xl:p-[7.75rem]">
            ...
            <div className="mt-8 lg:mt-12 xl:mt-16 grid sm:grid-cols-2 md:flex md:justify-between gap-3.5 md:gap-12 lg:gap-20 xl:gap-40">
                <div className="py-2.5  md:bg-white md:py-0 flex justify-center gap-0.5 bg-[#FAFAFA] rounded-lg">
                   <Image src={companyone} className="max-w-[35%] md:max-w-full mx-auto  object-contain  h-6 md:h-fit" alt="company"/>
                </div>
                <div className="py-2.5 md:bg-white md:py-0 flex justify-center gap-0.5 bg-[#FAFAFA] rounded-lg">
                <Image src={companytwo} className="max-w-[35%] md:max-w-full mx-auto  object-contain h-6 md:h-fit" alt="company"/>
                </div>
                <div className="py-2.5 md:bg-white md:py-0 flex justify-center gap-0.5 bg-[#FAFAFA] rounded-lg">
                <Image src={companythree} className="max-w-[35%] md:max-w-full mx-auto  object-contain  h-6 md:h-fit" alt="company"/>
                </div>
                <div className="py-2.5 md:bg-white md:py-0 flex justify-center gap-0.5 bg-[#FAFAFA] rounded-lg">
                <Image src={companyforth} className="max-w-[35%] md:max-w-full mx-auto  object-contain h-6 md:h-fit" alt="company"/>
                </div>
                <div className="py-2.5 md:bg-white md:py-0 md:flex justify-center gap-0.5 bg-[#FAFAFA] rounded-lg hidden">
                <Image src={companyfive} className="max-w-[35%] md:max-w-full mx-auto  object-contain h-6 md:h-fit" alt="company"/>
                </div>
            </div>
        </div>
        </>
